...
var author$project$Main$initialImage = {url: 'images/is-this-a-pigeon.jpg'};
var author$project$Main$emptyMeme = {captions: _List_Nil, height: 671, image: author$project$Main$initialImage, width: 1118};
var author$project$Main$localStoragePrefix = 'elm-meme-maker';
		...
		return Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
			{
				...
				key: key,
				meme: author$project$Main$emptyMeme,
				msg: elm$core$Maybe$Nothing
			});
	});
var author$project$Main$ProcessLocalStorage = function (a) {
	return {$: 'ProcessLocalStorage', a: a};
};
...
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2(author$project$PortFunnels$subscriptions, author$project$Main$ProcessLocalStorage, model)
			]));
};
...
var author$project$Main$getCmdPort = F2(
	function (moduleName, model) {
		return A3(author$project$PortFunnels$getCmdPort, author$project$Main$ProcessLocalStorage, moduleName, false);
	});
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var value = msg.a;
				var _n2 = A4(author$project$PortFunnels$processValue, author$project$Main$funnelDict, value, model.funnelState, model);
				if (_n2.$ === 'Err') {
					var error = _n2.a;
					return Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
						_Utils_update(
...
var author$project$Main$renderMeme = function (meme) {
	var w = elm$core$String$fromInt(meme.width);
	var url = meme.image.url;
	var image = meme.image;
	var h = elm$core$String$fromInt(meme.height);
	return A2(
		elm$svg$Svg$svg,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Elm Meme Maker')
							])),
						A2(
						elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								author$project$Main$renderMeme(model.meme)
							])),
						A2(
						elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								elm$html$Html$text(author$project$Main$chars.copyright + ' 2019 Bill St. Clair'),
								author$project$Main$br,
								A2(
								elm$html$Html$a,
								_List_fromArray(
									[
										elm$html$Html$Attributes$href('https://github.com/billstclair/elm-meme-maker')
									]),
								_List_fromArray(
									[
...
var author$project$Main$main = elm$browser$Browser$application(
	{init: author$project$Main$init, onUrlChange: author$project$Main$HandleUrlChange, onUrlRequest: author$project$Main$HandleUrlRequest, subscriptions: author$project$Main$subscriptions, update: author$project$Main$update, view: author$project$Main$view});
